...
console.log(frutas.lenght); // 4 - Retorna a quantidade de itens na lista/array
...
console.log(frutas.splice(1,1,"limão"))//Em listas utilizamos o splice para remover e substituir elemesntos em determinadas posições
console.log(frutas);
frutas[1] = "uva";
...
let valor = 123.456;
console.log(valor.toFixed(2)); // "123.456"
